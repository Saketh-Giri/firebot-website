...
export const ftc: Program = {
  ...
  subteams: [
    ...
    { name: "Business", description: "Notebook, grants, and judge presentations." },
    { name: "Marketing", description: "Outreach, photography, and how the team shows up." },
    { name: "Community Impact", description: "STEAM lessons, kits, and local events." },
  ],
  logo: "/images/ftc/01-firsttech-iconvert-rgb.png",
  teams: [
    { name: "Sparkbots", number: "16532", image: "/images/ftc/02-sparkbot-head.png", href: "https://ftc-events.firstinspires.org/team/16532" },
    { name: "Infernobots", number: "16533", image: "/images/ftc/03-infernobot-head.png", href: "https://ftc-events.firstinspires.org/team/16533" },
    { name: "Emberbots", number: "26106", image: "/images/ftc/04-emberbots-head.png", href: "https://ftc-events.firstinspires.org/team/26106" },
    { name: "Electrobots", number: "30541", image: "/images/home/05-7ebe-mv2.png", href: "https://ftc-events.firstinspires.org/team/30541" },
  ],
};
