  ...
  return (
    <>
      <PageHero
        eyebrow="Calendar"
        title="When we meet."
        lede="Build season Jan–Apr. Outreach year-round."
      />
      ...
      <Section heading="Be there." tone="surface">
        <div className="flex flex-wrap gap-4">
          <ButtonLink href="/join-the-team" withArrow>
            Join
          </ButtonLink>
          <ButtonLink href="/previous-events" variant="secondary">
            Past events
          </ButtonLink>
        </div>
      </Section>
