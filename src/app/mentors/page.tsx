...
import { mentorGroups, mentorsIntro } from "@/content/people";

export const metadata: Metadata = {
  title: "Mentors",
  description: "Engineers and professionals who advise Firebots.",
};

export default function MentorsPage() {
  return (
    <>
      <PageHero eyebrow="Mentors" title="The people behind us." lede={mentorsIntro} />
